...
gebco_lon_min, gebco_lon_max = 90.0, 100.0
gebco_lat_min, gebco_lat_max = 5.0, 10.0
...
plt.tight_layout()
plt.savefig('andaman.png', dpi=600, bbox_inches='tight', pad_inches=0.05)
plt.close()

print(f"大功告成！已保存: andaman.png")
